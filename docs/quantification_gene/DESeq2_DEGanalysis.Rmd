...
- Other comparisons:
    - Control vs DLB
        - Downregulated
            - GO terms related to cilium, cell projection, cilium assembly
            - KEGG terms related to amino acid metabolism
        - Upregulated
            - GO terms related to biological processes are very immune response oriented (e.g. “response to stimulus”, “regulation of immune response”), but also see locomotion terms, adhesion terms, terms related to blood vessel development and finally, to muscle contraction  
            - KEGG highlights leukocyte transendothelial migration, adhesion terms, muscle contraction
            - REACTOME terms relate to immune processes (including TLR4 cascade), muscle contraction, ECM organisation,
    - Control vs PD
        - Downregulated
            - GO terms related to phagosome & MHC class II antigen presentation
        - Upregulated
            - Terms relating to ion channels
    - Control vs PDD
        - Upregulated
            - GO BP terms relate to immune response and immune-related migration
            - REACTOME also highlights immune related terms (“innate immune system”)
    - PDD vs DLB
        - Upregulated
            - GO BP, GO CC and REACTOME terms relate to muscle systems? (“muscle contraction”, “muscle tissue development”, “regulation of muscle contraction”, “contractile fiber”, “sarcomere”)
    - PD vs DLB
        - Upregulated
            - Terms relating to immune processes and muscle cell differentiation
...
```{r gene-clusters, class.source='fold-show',fig.height=8}
