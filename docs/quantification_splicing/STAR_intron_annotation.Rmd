...
- Filtering removed any junctions that:
    ...
    - Form an intron of length < 25 nucleotides. This number is based on theoretical minimum intron length, which in 80% of cases includes (for references refer to Sonia Ruiz' document located locally in the directory: `C:\Users\rhrey\OneDrive - University College London\PhD\Other People's Projects\SoniaRuiz\20200107_Defining_junctions_length.docx`):
